...
This is a section of the [Cyfrin Updraft Advanced Foundry Course](https://updraft.cyfrin.io/). In this repo. It's all about signatures, merkle drops, and more.
